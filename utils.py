...
def imshow(args, im1, im2, im3, im4, e, i, whichrun="Train"):
    ...
    fig.colorbar(draw_voxels(im1, ax1), ax=ax1)
    ax2 = fig.add_subplot(2, 2, 2)
    fig.colorbar(draw_voxels(im2, ax2), ax=ax2)
    ax3 = fig.add_subplot(2, 2, 3)
    fig.colorbar(draw_voxels(im3, ax3), ax=ax3)
    ax4 = fig.add_subplot(2, 2, 4)
    fig.colorbar(draw_voxels(im4, ax4), ax=ax4)
